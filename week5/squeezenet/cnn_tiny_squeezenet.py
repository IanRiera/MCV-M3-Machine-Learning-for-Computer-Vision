...
from tiny_squeezenet import *

results_dir = '../results/fancy/tiny_squeezenet_'
log_dir = '../log/fancy'
weights_dir = '../weights/fancy/tiny_squeezenet_'
model_dir = '../models/fancy/tiny_squeezenet_'
...
WEIGHTS = "/home/group04/week5/weights/baseline/model_weights"
...
#plot_model(model, to_file=results_dir +'model_squezeenet.png', show_shapes=True, show_layer_names=True)
...
'''
_, validation_accuracy = model.evaluate_generator(test_generator, validation_samples)
...
print("This model squeeze has {} parameters and a ratio of {}".format(num_parameters, ratio))