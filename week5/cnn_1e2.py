...
results_dir = '../results/advanced/1e2_'
log_dir = '../log/advanced/'
weights_dir = '../weights/advanced/1e2_'
model_dir = '../models/advanced/1e2_'
...
print("This model 1e2 has {} parameters and a ratio of {}".format(num_parameters, ratio))