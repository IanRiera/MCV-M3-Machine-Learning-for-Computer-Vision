...
results_dir = '../results/baseline_tuning/3_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/3_'
model_dir = '../models/baseline_tuning/3_'
...
model.add(Conv2D(32,  kernel_size=(3, 3), activation='relu', kernel_initializer=initializer,name='conv2'))
model.add(MaxPooling2D(pool_size=(2, 2),name='pool2'))
model.add(Conv2D(32,  kernel_size=(3, 3), activation='relu', kernel_initializer=initializer,name='conv3'))
...
print("This model 3 has {} parameters and a ratio of {}".format(num_parameters, ratio))