...
results_dir = '../results/baseline_tuning/4_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/4_'
model_dir = '../models/baseline_tuning/4_'
...
print("This model 4 has {} parameters and a ratio of {}".format(num_parameters, ratio))