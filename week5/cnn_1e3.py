...
results_dir = '../results/advanced/1e3_'
log_dir = '../log/advanced/'
weights_dir = '../weights/advanced/1e3_'
model_dir = '../models/advanced/1e3_'
...
print("This model 1e3 has {} parameters and a ratio of {}".format(num_parameters, ratio))