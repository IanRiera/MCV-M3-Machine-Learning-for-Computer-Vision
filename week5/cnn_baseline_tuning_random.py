...
results_dir = '../results/baseline_tuning/random_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/random_'
model_dir = '../models/baseline_tuning/random_'
...
print("This model random has {} parameters and a ratio of {}".format(num_parameters, ratio))