...
results_dir = '../results/advanced/sgd_'
log_dir = '../log/advanced/'
weights_dir = '../weights/advanced/sgd_'
model_dir = '../models/advanced/sgd_'
...
print("This model sgd has {} parameters and a ratio of {}".format(num_parameters, ratio))