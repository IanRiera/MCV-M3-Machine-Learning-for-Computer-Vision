...
results_dir = '../results/baseline_tuning/drop_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/drop_'
model_dir = '../models/baseline_tuning/drop_'
...
print("This model drop has {} parameters and a ratio of {}".format(num_parameters, ratio))