...
results_dir = '../results/advanced/1e1_'
log_dir = '../log/advanced/'
weights_dir = '../weights/advanced/1e1_'
model_dir = '../models/advanced/1e1_'
...
print("This model 1e1 has {} parameters and a ratio of {}".format(num_parameters, ratio))