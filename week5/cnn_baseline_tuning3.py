...
save_accuracy(history, results_dir+"3_", baseline=0.78, legend_name='Baseline', xmax=number_of_epoch)
save_loss(history, results_dir+"3_", baseline=1.2 ,legend_name='Baseline', xmax=number_of_epoch)
