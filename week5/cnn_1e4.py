...
results_dir = '../results/advanced/1e4_'
log_dir = '../log/advanced/'
weights_dir = '../weights/advanced/1e4_'
model_dir = '../models/advanced/1e4_'
...
print("This model 1e4 has {} parameters and a ratio of {}".format(num_parameters, ratio))