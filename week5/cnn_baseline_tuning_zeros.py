...
results_dir = '../results/baseline_tuning/zeros_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/zeros_'
model_dir = '../models/baseline_tuning/zeros_'
...
print("This model zeros has {} parameters and a ratio of {}".format(num_parameters, ratio))