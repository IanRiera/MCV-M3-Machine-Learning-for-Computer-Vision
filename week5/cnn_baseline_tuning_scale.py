...
results_dir = '../results/baseline_tuning/rescale_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/rescale_'
model_dir = '../models/baseline_tuning/rescale_'
...
print("This model rescaling has {} parameters and a ratio of {}".format(num_parameters, ratio))