...
results_dir = '../results/baseline_tuning/64_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/64_'
model_dir = '../models/baseline_tuning/64_'
...
save_accuracy(history, results_dir+"64_", baseline=None, legend_name='LR: 1e-1', xmax=number_of_epoch)
save_loss(history, results_dir+"64_", baseline=None ,legend_name='LR: 1e-1', xmax=number_of_epoch)
