...
results_dir = '../results/baseline_tuning/16_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/16_'
model_dir = '../models/baseline_tuning/16_'
...
model.add(Conv2D(16, kernel_size=(3, 3), strides=(1, 1), activation='relu',input_shape=(img_size, img_size, 3),name='first'))
model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2),name='second'))
model.add(Conv2D(16,  kernel_size=(3, 3), activation='relu',name='third'))
...
save_accuracy(history, results_dir+"16_", baseline=None, legend_name='LR: 1e-1', xmax=number_of_epoch)
save_loss(history, results_dir+"16_", baseline=None ,legend_name='LR: 1e-1', xmax=number_of_epoch)

num_parameters = model.count_params()
ratio = validation_accuracy / (num_parameters / 100000)
print("This model 16 has {} parameters and a ratio of {}".format(num_parameters, ratio))