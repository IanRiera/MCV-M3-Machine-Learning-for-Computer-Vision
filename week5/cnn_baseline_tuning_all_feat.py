...
results_dir = '../results/baseline_tuning/all_feat_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/all_feat_'
model_dir = '../models/baseline_tuning/all_feat_'
...
print("This model all_feat has {} parameters and a ratio of {}".format(num_parameters, ratio))
print("This model all_samp has {} parameters and a ratio of {}".format(num_parameters, ratio))