...
results_dir = '../results/baseline_tuning/glorot_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/glorot_'
model_dir = '../models/baseline_tuning/glorot_'
...
print("This model glorot has {} parameters and a ratio of {}".format(num_parameters, ratio))