...
results_dir = '../results/baseline_tuning/5_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/5_'
model_dir = '../models/baseline_tuning/5_'
...
model = Sequential()
model.add(Conv2D(32, kernel_size=(3, 3), strides=(1, 1), activation='relu',input_shape=(img_size, img_size, 3), kernel_initializer=initializer,name='conv1'))
...
model.add(Conv2D(32,  kernel_size=(3, 3), activation='relu',padding="same", kernel_initializer=initializer,name='conv3'))
model.add(MaxPooling2D(pool_size=(2, 2),name='pool3'))
model.add(Conv2D(32,  kernel_size=(3, 3), activation='relu',padding="same", kernel_initializer=initializer,name='conv4'))
model.add(MaxPooling2D(pool_size=(2, 2),name='pool4'))
model.add(Conv2D(32,  kernel_size=(3, 3), activation='relu',padding="same", kernel_initializer=initializer,name='conv5'))
...
print("This model 5 has {} parameters and a ratio of {}".format(num_parameters, ratio))