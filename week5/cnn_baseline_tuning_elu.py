...
results_dir = '../results/baseline_tuning/elu_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/elu_'
model_dir = '../models/baseline_tuning/elu_'
...
model.add(Conv2D(64, kernel_size=(3, 3), strides=(1, 1), activation='elu',input_shape=(img_size, img_size, 3),name='first'))
model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2),name='second'))
model.add(Conv2D(32,  kernel_size=(3, 3), activation='elu',name='third'))
...
save_accuracy(history, results_dir+"elu_", baseline=0.78, legend_name='Baseline', xmax=number_of_epoch)
save_loss(history, results_dir+"elu_", baseline=1.2 ,legend_name='Baseline', xmax=number_of_epoch)

num_parameters = model.count_params()
ratio = validation_accuracy / (num_parameters / 100000)
print("This model elu has {} parameters and a ratio of {}".format(num_parameters, ratio))