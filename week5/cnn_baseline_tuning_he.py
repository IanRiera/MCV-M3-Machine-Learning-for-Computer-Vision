...
results_dir = '../results/baseline_tuning/he_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/he_'
model_dir = '../models/baseline_tuning/he_'
...
print("This model he has {} parameters and a ratio of {}".format(num_parameters, ratio))