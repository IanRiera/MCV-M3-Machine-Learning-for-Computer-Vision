...
results_dir = '../results/baseline_tuning/all_sample_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/all_sample_'
model_dir = '../models/baseline_tuning/all_sample_'
...
print("This model all_sample has {} parameters and a ratio of {}".format(num_parameters, ratio))
print("This model all_sample has {} parameters and a ratio of {}".format(num_parameters, ratio))