...
results_dir = '../results/baseline_tuning/c_feat_'
log_dir = '../log/baseline_tuning/'
weights_dir = '../weights/baseline_tuning/c_feat_'
model_dir = '../models/baseline_tuning/c_feat_'
...
print("This model c_feat has {} parameters and a ratio of {}".format(num_parameters, ratio))
print("This model c_samp has {} parameters and a ratio of {}".format(num_parameters, ratio))