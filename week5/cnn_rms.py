...
results_dir = '../results/advanced/rms_'
log_dir = '../log/advanced/'
weights_dir = '../weights/advanced/rms_'
model_dir = '../models/advanced/rms_'
...
print("This model rms has {} parameters and a ratio of {}".format(num_parameters, ratio))